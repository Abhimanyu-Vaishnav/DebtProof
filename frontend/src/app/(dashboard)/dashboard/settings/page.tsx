                ...
                <SectionCard title="Theme Presets" icon="🎨">
                  <div className="py-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    {THEME_PRESETS.map((t) => (
                      ...
                      >
                        {settings.theme === t.id && (
                          <span className="absolute top-3 right-3 text-[var(--color-primary)] font-black text-sm">✓</span>
                        )}
                        <div className="flex items-center gap-2 mb-2">
                          <span className="text-xl">{t.icon}</span>
                          <div className="flex gap-1.5">
                            <div className="w-4 h-4 rounded-full border border-black/20" style={{ background: t.color }} />
                            <div className="w-4 h-4 rounded-full border border-black/20" style={{ background: t.accent }} />
                          </div>
                        </div>
